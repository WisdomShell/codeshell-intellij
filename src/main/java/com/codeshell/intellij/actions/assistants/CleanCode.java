...
public class CleanCode extends DumbAwareAction implements IntentionAction {
    ...
    public void actionPerformed(@NotNull AnActionEvent e) {
        ...
        ApplicationManager.getApplication().invokeLater(() -> {
            ...
            Objects.requireNonNull(tool.getToolWindow("CodeShell")).activate(() -> System.out.println("******************* CleanCode Enabled CodeShell window *******************"), true, true);
